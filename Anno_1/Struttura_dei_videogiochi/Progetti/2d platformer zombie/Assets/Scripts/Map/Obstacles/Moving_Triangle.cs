...
public class Moving_Triangle : MonoBehaviour
{
    public Moving_rect moving_rect;// taking all values from moving_rect

    private float range;
    private float speed;
    private float start_delay;
    private float time_still;

    // determines the direction of the rect
    private Direction direction;
    // tells if the rect can change from the original direction
    private bool direction_changable;
    ...
    void Start()
    {
        // initializing vars based on Moving_rect
        range = moving_rect.range;
        speed = moving_rect.speed;
        start_delay = moving_rect.start_delay;
        time_still = moving_rect.time_still;

        direction = (Direction) moving_rect.Direction_rect;
